...
export const SchemeCanvas = forwardRef(
  (
    {
      nodes,
      edges,
    ...
    const onDrop = useCallback(
      (event: React.DragEvent) => {
        ...
        const type = event.dataTransfer.getData("application/reactflow-type"); // <-- type bilgisini al!
        ...
        const newNode: Node<RFNodeData> = {
          ...
          type: "default",
          position,
          data: { id: getId(), label, type, color, properties: {} }, // <-- type burada!
          style: {
        ...
        onNodeSelect(newNode); // Sürükleyince sağ panelde form açılsın
      },
    ...
    const handleEdgeModalSave = (relationType: string) => {
      if (pendingEdge && pendingEdge.source && pendingEdge.target) {
        setEdges((eds) =>
          addEdge(
            {
              ...pendingEdge,
